...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2018 at 05:13 AM
...
INSERT INTO `work_order` (`WOID`, `VehicleID`, `WODateTime`, `OrderDescription`) VALUES
('WO001', 'VH001', '2018-12-19 10:21:49', 'ABCD'),
('WO002', 'VH002', '2018-12-19 10:23:50', 'EFGH');
...
--
ALTER TABLE `work_order`
  ADD CONSTRAINT `work_order_ibfk_1` FOREIGN KEY (`VehicleID`) REFERENCES `vehicle` (`VehicleID`);
